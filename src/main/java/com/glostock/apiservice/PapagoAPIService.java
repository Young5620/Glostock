...
public class PapagoAPIService {
    ...
    public static String translateENtoKR(String en_text) {
        ...
        String text;
        try {
            text = URLEncoder.encode(en_text, "UTF-8");
        ...
        try {
            translatedObject = jObject.getJSONObject("message");
            translatedObject = translatedObject.getJSONObject("result");
            result = translatedObject.getString("translatedText");
