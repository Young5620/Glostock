...
<main class="form-signin">
  ...
  <form action="userLeave" method="post">
    ...
    <h1 class="h3 mb-3 fw-normal">원활한 회원탈퇴를 위해 <br>다시 한번 로그인 해주세요.</h1>
    ...
    <div class="form-floating">
      ...
      <label for="floatingPassword">비밀번호</label>
        ...
        <div class="form-floating">
      <input type="password" class="form-control" id="whyleave" name="whyleave" placeholder="탈퇴사유">
      <label for="floatingPassword">탈퇴사유</label>
    </div>

    <button  class="w-100 btn btn-secondary" onclick="leave()">탈퇴하기</button>
