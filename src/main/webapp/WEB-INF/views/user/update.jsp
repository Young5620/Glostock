  ...
  <main class="form-join">
    <div class="input-form-backgroud row">
      <div class="input-form col-md-12 mx-auto">
       ...
       <br> 
       <br> 
        <form class="validation-form" name="updateform" id="updateform" action="updateForm" method="post">
          <div class="row">
            <div class="col-md-6 mb-3">
              <label for="username">이름</label>
              <input type="text" class="form-control" id="username" name="username" placeholder="${mypage.username}" value="" >
           
            </div>
            
            <div class="col-md-6 mb-3">
              <label for="nickname">별명(작성자)</label>
              <input type="text" class="form-control" id="nickname" name="nickname" placeholder="${mypage.nickname}"  >
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="phone" name="phone" placeholder="${mypage.phone }" >
          </div>
          ...
          <div class="mb-4"></div>
          <button class="w-100 btn btn-secondary" onclick="register()">개인정보 변경하기</button>
        </form>
        <div><br> </div>
...
<script type="text/javascript">
	function register() {
			...
			} else if (document.updateform.nickname.value==''){  
				alert("별명은 필수입력사항입니다.");
				return;
